 ...
 *
 */
#include "physicsengine\pcontacts.h"

using namespace PhysicsEngine;

// Contact implementation

void ParticleContact::resolve(double dElapsedFrameTime)
{
    resolveVelocity(dElapsedFrameTime);
    resolveInterpenetration(dElapsedFrameTime);
}
...
void ParticleContact::resolveVelocity(double dElapsedFrameTime)
{
    ...
    double accCausedSepVelocity = accCausedVelocity * contactNormal * dElapsedFrameTime;
...
void ParticleContact::resolveInterpenetration(double dElapsedFrameTime)
{
                                              ...
                                              double dElapsedFrameTime)
{
    ...
    while(iterationsUsed < iterations)
    {
        ...
        contactArray[maxIndex].resolve(dElapsedFrameTime);
