...
void InitAllVertexDeclarations()
{
	...
	HR(g_d3dDevice->CreateVertexDeclaration(VertexPosElements, &VertexPos::Decl));
	...
	HR(g_d3dDevice->CreateVertexDeclaration(VertexColElements, &VertexCol::Decl));
	...
	HR(g_d3dDevice->CreateVertexDeclaration(VertexPNElements, &VertexPN::Decl));
	...
	HR(g_d3dDevice->CreateVertexDeclaration(VertexPNTElements, &VertexPNT::Decl));
}
