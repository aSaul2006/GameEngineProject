...
/************************************************************************
*  Program Name:		CellSpacePartition.h							*
*  Name:				James B. Strickler II							*
*  Date:				January 25, 2013								*
*  Description:			Class to divide a 2D space into a grid of		*
*						cells each of which may contain a number of		*
*						entities. Once created and initialized			*
*						with entities, fast proximity querys can be		*
*						made by calling the CalculateNeighbors method	*
*						with a position and proximity radius.			*
*																		*
*						If an entity is capable of moving, and			*
*						therefore capable of moving between cells,		*
*						the Update method should be called each			*
*						update-cycle to sychronize the entity and		*
*						the cell space it occupies						*
*  Update:																*
*																		*
************************************************************************/
