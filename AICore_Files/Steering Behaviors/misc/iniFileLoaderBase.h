...
/************************************************************************
*  Program Name:		IniFileLoaderBase.h								*
*  Name:				James B. Strickler II							*
*  Date:				January 25, 2013								*
*  Description:			Header for the IniFileLoaderBase class used  	*
*						to inherit from this to create a class			*
*						capable of reading parameters					*
*						from an ascii file								*
*																		*
*						instantiate this class with the name of the		*
*						parameter file. Then call the helper			*
