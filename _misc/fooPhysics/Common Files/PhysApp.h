/***************************************************************************************
*  Program Name:    PhysApp.h                                                          *         
*  Name:            Bryan Sweeney                                                      *
*  Date:            February 14, 2013                                                  *
*  Description:     This file contains The  base application class for all demos.      *
...
protected:
    ...
    PhysicsEngine::Particle *particleArray;
    PhysicsEngine::GroundContacts groundContactGenerator;
 ...
 */
 ...
 protected:
    ...
    virtual void updateObjects(double dElapsedFrameTime) = 0;
